...
import { duckContainer, contentContainer, avatar, actionContainer,
         header, text, likeReplyContainer, likedIcon, icon, author,
} from './styles.css'
    ...
    onClick={props.onClick}>
      ...
      <div className={contentContainer}>
        <div className={header}>
          ...
          <div>
            {formatTimeStamp(props.duck.get('timestamp'))}
          </div>
        </div>
